...
import { AssistantTrigger } from "@/components/assistant";
                    ...
                    <div>
                      {group.items.map((item, itemIndex) => {
                        ...
                        const isActive = isProspectionItem 
                          ...
                          : pathname === item.href || (pathname.startsWith(item.href + "/") && !pathname.includes("/leads"));
                        ...
                        const navItemContent = (
                          <>
                            ...
                            {!isCollapsed && (
                              <>
                                <span 
                                  className="truncate transition-all flex-1"
                                  style={{
                                ...
                                {isProspectionItem && (
                                  <ChevronDown 
                                    ...
                                    style={{ 
                                      color: isActive ? "#FFFFFF" : "#9aa1a7",
                                      transform: prospectionOpen ? "rotate(180deg)" : "rotate(0deg)"
                                    }} 
                                  />
                                )}
                              </>
                        ...
                        // Special handling for Prospection item with dropdown
                        if (isProspectionItem) {
                          const prospectionDropdown = (
                              ...
                              >
                                {assignedCampaigns.length === 0 ? (
                                  ...
                                  assignedCampaigns.map((campaign) => (
                                    <DropdownMenuItem
                                      key={campaign.id}
                                      onClick={() => handleProspectionClick(campaign.id)}
